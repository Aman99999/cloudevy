...
docker tag cloudevy-frontend:latest $REGISTRY/$NAMESPACE/cloudevy-frontend:$VERSION
docker push $REGISTRY/$NAMESPACE/cloudevy-frontend:$VERSION
echo ""
echo "✅ Frontend image pushed successfully to $REGISTRY/$NAMESPACE"
